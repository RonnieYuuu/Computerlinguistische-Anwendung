...
def token_ngrams(tokens, n):
    ...
    # TODO Exercise 1.1
    return [" ".join(tokens[t:t+n]) for t in range(len(tokens)-n+1)]
...
def char_ngram_features(ngrams1, ngrams2):
    features = dict()
    # TODO Exercise 1.4
    ...
    with open(filename, 'r') as myfile:
        for line in myfile:
            ...
            if f_c_ngram:
                ...
                features.update(char_ngram_features(character_ngrams1, character_ngrams2))
            if f_wordpair:

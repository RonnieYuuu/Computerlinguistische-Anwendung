...
from hw03_sklearn_paraphrases import paraphrases_scikit as ps
import numpy as np


class Test_paraphrases_scikit(TestCase):
    def setUp(self):
        self.trainpath_small = "unittest-toydata/train.txt"
        self.devpath_small = "unittest-toydata/dev.txt"
        self.testpath_small = "unittest-toydata/test.txt"

...
from src.hw02_paraphrases import paraphrases
...
class FeaturesTest(TestCase):
    ...
    # Exercise 1.4
    def test04_char_ngram_features(self):
        features = dict()
        features[paraphrases.CHARACTER_NGRAM_OVERLAP] = 39
        features[paraphrases.CHARACTER_NGRAM_UNION] = 60
        self.assertEqual(features, paraphrases.char_ngram_features(self.character_ngrams1, self.character_ngrams2))

...
class TestSmallFunctions(TestCase):
    ...
    # Exercise 2.1
    def test01a_square_root_equi(self):
        np.testing.assert_almost_equal([2., 2.54950976, 3.], sf.square_root_equi(4, 9, 3))

    # Exercise 2.1
    def test01b_square_root_equi(self):
        np.testing.assert_almost_equal([1.], sf.square_root_equi(1, 2, 1))
